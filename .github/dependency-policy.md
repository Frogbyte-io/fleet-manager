...
| `MIT-0` | Permissive; explicitly grants usage **without** the attribution requirement, public-domain-equivalent like `CC0-1.0`. Enters the graph with the web toolchain (`@csstools/*` helpers under the CSS nesting polyfills), reviewed in [#74](https://github.com/Frogbyte-io/fleet-manager/pull/74). |
