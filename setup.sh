...
if [ ! -f "$AGENTS_FILE" ]; then
  echo "Warning: AGENTS.md not found in this repo — it's expected to live in your separate fleet data repo now; skipping the Codex/Claude Code global-instructions symlink. Run \`agents-registry init\` to set up your data repo, then wire its AGENTS.md manually if you want the symlink." >&2
else
