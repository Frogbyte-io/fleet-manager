...
### FM-711 — Add Lab leases, cleanup, and the expiry sweeper

**Context:** FM-710's provisioning records are the foundation; epic #14 completes the Lab core.
**Status:** Done 2026-09-23 (issue #116, PR #117). See the M7 status line above for the delivery summary and the review history.
